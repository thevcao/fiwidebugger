...
(function () {
  ...
  if (env.includes("staging") || env.includes("local")) {
    ...
    var css = '@import "https://s3.amazonaws.com/fw-devtools/fiwi-debugger/css/style.min.css"; .fiwi-debugger {position: fixed};',
